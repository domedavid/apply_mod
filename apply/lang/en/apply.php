...
$string['entry_saved'] = 'Your application has been saved. Thank you.';
$string['entry_saved_draft'] = 'Your application has been saved as <strong>Draft</strong>.';
...
$string['textarea_minlength'] = 'Minimal length required';
$string['textarea_height'] = 'Number of lines';
$string['textarea_width'] = 'Width';
$string['textfield'] = 'Short text answer';
$string['date'] = 'Date & Interval';
$string['datefield'] = 'Date & Interval';
...
$string['special_textfield'] = 'Special type';
$string['job_desc'] = 'Job description';
